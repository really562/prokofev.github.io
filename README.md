...
* В системе: 30*15 = 450 мин/день; 450*20 = 900 мин = 15 ч (за рассмотренный период).
* Без системы: 40*30 = 1200 мин/день; 1200*20 = 2400 мин = 40 ч (за рассмотренный период).
* Пусть 5 сотрудников в день пользуются системой: 5*30*15 = 2250 ч/час.
* Если сотрудники не пользуются системой: 5*30*40 = 6000 ч/час.
